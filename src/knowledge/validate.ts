...
const KNOWLEDGE_TEAM_READINESS_BLOCKERS = [
...
const KNOWLEDGE_TEAM_READINESS_STATUSES = [
  'already-published',
  'blocked',
  'conflict',
  'upload-required'
] as const;
const KNOWLEDGE_TEAM_READINESS_NEXT_ACTIONS = [
  'none',
...
function validateKnowledgeTeamArtifactIndexEntryPayload(
  payload: Record<string, unknown>,
  inputPath: string,
  inputKind: string
): KnowledgeValidationReport {
...
function validateKnowledgeTeamPublicationReadinessPayload(
  payload: Record<string, unknown>,
  inputPath: string,
  inputKind: string
): KnowledgeValidationReport {
...
function validateKnowledgeTeamBackendReadinessPayload(
  payload: Record<string, unknown>,
  inputPath: string,
  inputKind: string
): KnowledgeValidationReport {
