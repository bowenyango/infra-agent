...
import { buildKnowledgeTeamUploadCredentialPresenceBoundary } from '../knowledge/team-upload-credential-presence-boundary.ts';
import { buildKnowledgeTeamUploadLiveCheckBoundary } from '../knowledge/team-upload-live-check-boundary.ts';
import { buildKnowledgeTeamUploadCommandBoundary } from '../knowledge/team-upload-command-boundary.ts';
import { buildKnowledgeTeamUploadObjectIndexBindingBoundary } from '../knowledge/team-upload-object-index-binding-boundary.ts';
import { buildKnowledgeTeamUploadExecutionReadinessBoundary } from '../knowledge/team-upload-execution-readiness-boundary.ts';
import { buildKnowledgeTeamUploadExecutionApprovalRequest } from '../knowledge/team-upload-execution-approval-request.ts';
import { buildKnowledgeTeamUploadExecutionApprovalRecord } from '../knowledge/team-upload-execution-approval-record.ts';
import { buildKnowledgeTeamUploadExecutionAuthorizationBoundary } from '../knowledge/team-upload-execution-authorization-boundary.ts';
import { buildKnowledgeTeamUploadExecutionPlanRulesReview } from '../knowledge/team-upload-execution-plan-rules-review.ts';
import { buildKnowledgeTeamUploadExecutionPlanRulesUpdateRecord } from '../knowledge/team-upload-execution-plan-rules-update-record.ts';
import { buildKnowledgeTeamUploadExecutionImplementationBoundary } from '../knowledge/team-upload-execution-implementation-boundary.ts';
import { buildKnowledgeTeamUploadExecutionRuntimeBoundaries } from '../knowledge/team-upload-execution-runtime-boundaries.ts';
import { buildKnowledgeTeamUploadExecutionRuntimeBoundaryPolicyReview } from '../knowledge/team-upload-execution-runtime-boundary-policy-review.ts';
...
import {
  ...
  printKnowledgeTeamUploadCredentialPresenceBoundary,
  printKnowledgeTeamUploadLiveCheckBoundary,
  printKnowledgeTeamUploadCommandBoundary,
  printKnowledgeTeamUploadObjectIndexBindingBoundary,
  printKnowledgeTeamUploadExecutionReadinessBoundary,
  printKnowledgeTeamUploadExecutionApprovalRequest,
  printKnowledgeTeamUploadExecutionApprovalRecord,
  printKnowledgeTeamUploadExecutionAuthorizationBoundary,
  printKnowledgeTeamUploadExecutionPlanRulesReview,
  printKnowledgeTeamUploadExecutionPlanRulesUpdateRecord,
  printKnowledgeTeamUploadExecutionImplementationBoundary,
  printKnowledgeTeamUploadExecutionRuntimeBoundaries,
  printKnowledgeTeamUploadExecutionRuntimeBoundaryPolicyReview,
...
export function parseArgs(argv: string[]): ParsedArgs {
  ...
  if (commandName === 'knowledge') {
    ...
    if (
      ...
      && knowledgeAction !== 'upload-credential-presence-boundary'
      && knowledgeAction !== 'upload-live-check-boundary'
      && knowledgeAction !== 'upload-command-boundary'
      && knowledgeAction !== 'upload-object-index-binding-boundary'
      && knowledgeAction !== 'upload-execution-readiness-boundary'
      && knowledgeAction !== 'request-separate-upload-execution-approval'
      && knowledgeAction !== 'record-human-upload-execution-approval'
      && knowledgeAction !== 'upload-execution-authorization-boundary'
      && knowledgeAction !== 'upload-execution-plan-rules-review'
        && knowledgeAction !== 'record-upload-execution-plan-rules-update'
        && knowledgeAction !== 'upload-execution-implementation-boundary'
    ...
    for (let index = 0; index < actionArgs.length; index += 1) {
      ...
      if (arg === '--domain') {
        if (knowledgeAction === 'validate' || knowledgeAction === 'publish-plan' || knowledgeAction === 'publish-readiness' || knowledgeAction === 'backend-readiness' || knowledgeAction === 'backend-reference-readiness' || knowledgeAction === 'upload-approval-intent' || knowledgeAction === 'upload-approval-continuation' || knowledgeAction === 'upload-adapter-preflight' || knowledgeAction === 'upload-mock-harness' || knowledgeAction === 'upload-execution-gate' || knowledgeAction === 'upload-mutation-plan' || knowledgeAction === 'upload-mutation-approval-review' || knowledgeAction === 'upload-execution-prerequisite-plan' || knowledgeAction === 'upload-write-token-boundary' || knowledgeAction === 'upload-execution-lease-boundary' || knowledgeAction === 'upload-rollback-plan-boundary' || knowledgeAction === 'upload-audit-record-boundary' || knowledgeAction === 'upload-artifact-bytes-boundary' || knowledgeAction === 'upload-adapter-injection-boundary' || knowledgeAction === 'upload-client-creation-boundary' || knowledgeAction === 'upload-credential-read-boundary' || knowledgeAction === 'upload-credential-presence-boundary' || knowledgeAction === 'upload-live-check-boundary' || knowledgeAction === 'upload-command-boundary' || knowledgeAction === 'upload-object-index-binding-boundary' || knowledgeAction === 'upload-execution-readiness-boundary' || knowledgeAction === 'request-separate-upload-execution-approval' || knowledgeAction === 'record-human-upload-execution-approval' || knowledgeAction === 'upload-execution-authorization-boundary' || knowledgeAction === 'upload-execution-plan-rules-review' || knowledgeAction === 'record-upload-execution-plan-rules-update' || knowledgeAction === 'upload-execution-implementation-boundary' || knowledgeAction === 'upload-execution-runtime-boundaries' || knowledgeAction === 'upload-execution-runtime-boundary-policy-review') {
      ...
      if (arg === '--approval-fingerprint') {
        ...
        if (knowledgeAction !== 'upload-approval-continuation' && knowledgeAction !== 'upload-mutation-approval-review' && knowledgeAction !== 'record-human-upload-execution-approval') {
          fail('--approval-fingerprint is only supported for knowledge upload-approval-continuation, knowledge upload-mutation-approval-review, or knowledge record-human-upload-execution-approval.');
        }
      ...
      if (arg === '--review-fingerprint') {
        const reviewFingerprintValue = actionArgs[index + 1]?.trim();
        if (!reviewFingerprintValue) {
          fail('Missing value for --review-fingerprint.');
        }
        if (knowledgeAction !== 'record-upload-execution-plan-rules-update') {
          fail('--review-fingerprint is only supported for knowledge record-upload-execution-plan-rules-update.');
        }
        if (reviewFingerprint !== null) {
          fail('Review fingerprint can be provided at most once.');
        }

        reviewFingerprint = reviewFingerprintValue;
        index += 1;
        continue;
      }
    ...
    if (knowledgeAction === 'upload-credential-presence-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-credential-presence-boundary requires exactly one upload credential read boundary path.');
    }
    if (knowledgeAction === 'upload-live-check-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-live-check-boundary requires exactly one upload credential presence boundary path.');
    }
    if (knowledgeAction === 'upload-command-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-command-boundary requires exactly one upload live check boundary path.');
    }
    if (knowledgeAction === 'upload-object-index-binding-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-object-index-binding-boundary requires exactly one upload command boundary path.');
    }
    if (knowledgeAction === 'upload-execution-readiness-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-execution-readiness-boundary requires exactly one upload object/index binding boundary path.');
    }
    if (knowledgeAction === 'request-separate-upload-execution-approval' && positionalArgs.length !== 1) {
      fail('knowledge request-separate-upload-execution-approval requires exactly one upload execution readiness boundary path.');
    }
    if (knowledgeAction === 'record-human-upload-execution-approval' && positionalArgs.length !== 1) {
      fail('knowledge record-human-upload-execution-approval requires exactly one upload execution approval request path.');
    }
    if (knowledgeAction === 'upload-execution-authorization-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-execution-authorization-boundary requires exactly one upload execution approval record path.');
    }
    if (knowledgeAction === 'upload-execution-plan-rules-review' && positionalArgs.length !== 1) {
      fail('knowledge upload-execution-plan-rules-review requires exactly one upload execution authorization boundary path.');
    }
    if (knowledgeAction === 'record-upload-execution-plan-rules-update' && positionalArgs.length !== 1) {
      fail('knowledge record-upload-execution-plan-rules-update requires exactly one upload execution Plan/Rules review path.');
    }
    if (knowledgeAction === 'upload-execution-implementation-boundary' && positionalArgs.length !== 1) {
      fail('knowledge upload-execution-implementation-boundary requires exactly one upload execution Plan/Rules update record path.');
    }
      if (knowledgeAction === 'upload-execution-runtime-boundaries' && positionalArgs.length !== 1) {
        fail('knowledge upload-execution-runtime-boundaries requires exactly one upload execution implementation boundary path.');
      }
      if (knowledgeAction === 'upload-execution-runtime-boundary-policy-review' && positionalArgs.length !== 1) {
        fail('knowledge upload-execution-runtime-boundary-policy-review requires exactly one upload execution runtime-boundaries path.');
      }
    ...
    if (knowledgeAction === 'record-human-upload-execution-approval' && approvalFingerprint === null) {
      fail('knowledge record-human-upload-execution-approval requires --approval-fingerprint <sha256>.');
    }
    if (knowledgeAction === 'record-upload-execution-plan-rules-update' && reviewFingerprint === null) {
      fail('knowledge record-upload-execution-plan-rules-update requires --review-fingerprint <sha256>.');
    }
    ...
    return {
      ...
      knowledgeAction,
      task: null,
        workspace: knowledgeAction === 'validate' || knowledgeAction === 'publish-plan' || knowledgeAction === 'publish-readiness' || knowledgeAction === 'backend-readiness' || knowledgeAction === 'backend-reference-readiness' || knowledgeAction === 'upload-approval-intent' || knowledgeAction === 'upload-approval-continuation' || knowledgeAction === 'upload-adapter-preflight' || knowledgeAction === 'upload-mock-harness' || knowledgeAction === 'upload-execution-gate' || knowledgeAction === 'upload-mutation-plan' || knowledgeAction === 'upload-mutation-approval-review' || knowledgeAction === 'upload-execution-prerequisite-plan' || knowledgeAction === 'upload-write-token-boundary' || knowledgeAction === 'upload-execution-lease-boundary' || knowledgeAction === 'upload-rollback-plan-boundary' || knowledgeAction === 'upload-audit-record-boundary' || knowledgeAction === 'upload-artifact-bytes-boundary' || knowledgeAction === 'upload-adapter-injection-boundary' || knowledgeAction === 'upload-client-creation-boundary' || knowledgeAction === 'upload-credential-read-boundary' || knowledgeAction === 'upload-credential-presence-boundary' || knowledgeAction === 'upload-live-check-boundary' || knowledgeAction === 'upload-command-boundary' || knowledgeAction === 'upload-object-index-binding-boundary' || knowledgeAction === 'upload-execution-readiness-boundary' || knowledgeAction === 'request-separate-upload-execution-approval' || knowledgeAction === 'record-human-upload-execution-approval' || knowledgeAction === 'upload-execution-authorization-boundary' || knowledgeAction === 'upload-execution-plan-rules-review' || knowledgeAction === 'record-upload-execution-plan-rules-update' || knowledgeAction === 'upload-execution-implementation-boundary' || knowledgeAction === 'upload-execution-runtime-boundaries' || knowledgeAction === 'upload-execution-runtime-boundary-policy-review' ? cwd() : workspace,
        inputPath: knowledgeAction === 'validate' || knowledgeAction === 'publish-plan' || knowledgeAction === 'publish-readiness' || knowledgeAction === 'backend-readiness' || knowledgeAction === 'backend-reference-readiness' || knowledgeAction === 'upload-approval-intent' || knowledgeAction === 'upload-approval-continuation' || knowledgeAction === 'upload-adapter-preflight' || knowledgeAction === 'upload-mock-harness' || knowledgeAction === 'upload-execution-gate' || knowledgeAction === 'upload-mutation-plan' || knowledgeAction === 'upload-mutation-approval-review' || knowledgeAction === 'upload-execution-prerequisite-plan' || knowledgeAction === 'upload-write-token-boundary' || knowledgeAction === 'upload-execution-lease-boundary' || knowledgeAction === 'upload-rollback-plan-boundary' || knowledgeAction === 'upload-audit-record-boundary' || knowledgeAction === 'upload-artifact-bytes-boundary' || knowledgeAction === 'upload-adapter-injection-boundary' || knowledgeAction === 'upload-client-creation-boundary' || knowledgeAction === 'upload-credential-read-boundary' || knowledgeAction === 'upload-credential-presence-boundary' || knowledgeAction === 'upload-live-check-boundary' || knowledgeAction === 'upload-command-boundary' || knowledgeAction === 'upload-object-index-binding-boundary' || knowledgeAction === 'upload-execution-readiness-boundary' || knowledgeAction === 'request-separate-upload-execution-approval' || knowledgeAction === 'record-human-upload-execution-approval' || knowledgeAction === 'upload-execution-authorization-boundary' || knowledgeAction === 'upload-execution-plan-rules-review' || knowledgeAction === 'record-upload-execution-plan-rules-update' || knowledgeAction === 'upload-execution-implementation-boundary' || knowledgeAction === 'upload-execution-runtime-boundaries' || knowledgeAction === 'upload-execution-runtime-boundary-policy-review' ? positionalArgs[0] : null,
...
export async function main(argv = process.argv.slice(2)): Promise<void> {
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-credential-presence-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-credential-presence-boundary requires exactly one upload credential read boundary path.');
    }

    const credentialReadBoundaryPath = resolveFromCwd(parsed.inputPath);
    const credentialReadBoundary = await readJsonObject(credentialReadBoundaryPath);
    ...
    printKnowledgeTeamUploadCredentialPresenceBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-live-check-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-live-check-boundary requires exactly one upload credential presence boundary path.');
    }

    const credentialPresenceBoundaryPath = resolveFromCwd(parsed.inputPath);
    const credentialPresenceBoundary = await readJsonObject(credentialPresenceBoundaryPath);
    ...
    printKnowledgeTeamUploadLiveCheckBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-command-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-command-boundary requires exactly one upload live check boundary path.');
    }

    const liveCheckBoundaryPath = resolveFromCwd(parsed.inputPath);
    const liveCheckBoundary = await readJsonObject(liveCheckBoundaryPath);
    ...
    printKnowledgeTeamUploadCommandBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-object-index-binding-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-object-index-binding-boundary requires exactly one upload command boundary path.');
    }

    const commandBoundaryPath = resolveFromCwd(parsed.inputPath);
    const commandBoundary = await readJsonObject(commandBoundaryPath);
    ...
    printKnowledgeTeamUploadObjectIndexBindingBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-execution-readiness-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-execution-readiness-boundary requires exactly one upload object/index binding boundary path.');
    }

    const objectIndexBindingBoundaryPath = resolveFromCwd(parsed.inputPath);
    const objectIndexBindingBoundary = await readJsonObject(objectIndexBindingBoundaryPath);
    ...
    printKnowledgeTeamUploadExecutionReadinessBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'request-separate-upload-execution-approval') {
    if (!parsed.inputPath) {
      fail('knowledge request-separate-upload-execution-approval requires exactly one upload execution readiness boundary path.');
    }

    const executionReadinessBoundaryPath = resolveFromCwd(parsed.inputPath);
    const executionReadinessBoundary = await readJsonObject(executionReadinessBoundaryPath);
    const request = buildKnowledgeTeamUploadExecutionApprovalRequest({
      executionReadinessBoundary
    });
    const writtenPath = parsed.outputPath
      ? await writeJsonArtifact(parsed.outputPath, cwd(), request)
      : null;
    ...
    printKnowledgeTeamUploadExecutionApprovalRequest(request);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'record-human-upload-execution-approval') {
    if (!parsed.inputPath) {
      fail('knowledge record-human-upload-execution-approval requires exactly one upload execution approval request path.');
    }
    if (!parsed.approvalFingerprint) {
    ...
    const executionApprovalRequestPath = resolveFromCwd(parsed.inputPath);
    const executionApprovalRequest = await readJsonObject(executionApprovalRequestPath);
    const record = buildKnowledgeTeamUploadExecutionApprovalRecord({
      executionApprovalRequest,
      approvalFingerprint: parsed.approvalFingerprint
    });
    const writtenPath = parsed.outputPath
      ? await writeJsonArtifact(parsed.outputPath, cwd(), record)
      : null;
    ...
    printKnowledgeTeamUploadExecutionApprovalRecord(record);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-execution-authorization-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-execution-authorization-boundary requires exactly one upload execution approval record path.');
    }

    const executionApprovalRecordPath = resolveFromCwd(parsed.inputPath);
    const executionApprovalRecord = await readJsonObject(executionApprovalRecordPath);
    ...
    printKnowledgeTeamUploadExecutionAuthorizationBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-execution-plan-rules-review') {
    if (!parsed.inputPath) {
      fail('knowledge upload-execution-plan-rules-review requires exactly one upload execution authorization boundary path.');
    }

    const executionAuthorizationBoundaryPath = resolveFromCwd(parsed.inputPath);
    const executionAuthorizationBoundary = await readJsonObject(executionAuthorizationBoundaryPath);
    ...
    printKnowledgeTeamUploadExecutionPlanRulesReview(review);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'record-upload-execution-plan-rules-update') {
    if (!parsed.inputPath) {
      fail('knowledge record-upload-execution-plan-rules-update requires exactly one upload execution Plan/Rules review path.');
    }
    if (!parsed.reviewFingerprint) {
      fail('knowledge record-upload-execution-plan-rules-update requires --review-fingerprint <sha256>.');
    }

    const planRulesReviewPath = resolveFromCwd(parsed.inputPath);
    const planRulesReview = await readJsonObject(planRulesReviewPath);
    const record = buildKnowledgeTeamUploadExecutionPlanRulesUpdateRecord({
      planRulesReview,
      reviewFingerprint: parsed.reviewFingerprint
    });
    const writtenPath = parsed.outputPath
      ? await writeJsonArtifact(parsed.outputPath, cwd(), record)
      : null;
    ...
    printKnowledgeTeamUploadExecutionPlanRulesUpdateRecord(record);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
  ...
  if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-execution-implementation-boundary') {
    if (!parsed.inputPath) {
      fail('knowledge upload-execution-implementation-boundary requires exactly one upload execution Plan/Rules update record path.');
    }

    const planRulesUpdateRecordPath = resolveFromCwd(parsed.inputPath);
    const planRulesUpdateRecord = await readJsonObject(planRulesUpdateRecordPath);
    ...
    printKnowledgeTeamUploadExecutionImplementationBoundary(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
    }
    return;
    ...
    if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-execution-runtime-boundaries') {
      if (!parsed.inputPath) {
        fail('knowledge upload-execution-runtime-boundaries requires exactly one upload execution implementation boundary path.');
      }

    const implementationBoundaryPath = resolveFromCwd(parsed.inputPath);
    const implementationBoundary = await readJsonObject(implementationBoundaryPath);
    ...
    printKnowledgeTeamUploadExecutionRuntimeBoundaries(boundary);
    if (writtenPath) {
      process.stdout.write(`\nwritten: ${writtenPath}\n`);
      }
      return;
    ...
    if (parsed.command === 'knowledge' && parsed.knowledgeAction === 'upload-execution-runtime-boundary-policy-review') {
      if (!parsed.inputPath) {
        fail('knowledge upload-execution-runtime-boundary-policy-review requires exactly one upload execution runtime-boundaries path.');
      }

      const runtimeBoundariesPath = resolveFromCwd(parsed.inputPath);
      const runtimeBoundaries = await readJsonObject(runtimeBoundariesPath);
      ...
      printKnowledgeTeamUploadExecutionRuntimeBoundaryPolicyReview(review);
      if (writtenPath) {
        process.stdout.write(`\nwritten: ${writtenPath}\n`);
      }
      return;
