...
const CANONICAL_PUBLIC_KNOWLEDGE_MARKDOWN = {
  terraformAwsProviderDocs: [
    ...
    '## Best Practices',
    '',
    'Pin provider versions and review identity-like names before changing infrastructure.',
    '',
    ...
    '3. Run terraform plan and inspect replacements before applying edits.',
    '',
    '## Troubleshooting',
    '',
  ...
  pulumiAwsPackageDocs: [
    ...
    '## Best Practices',
    '',
    'Review preview output before changing resource identity fields or provider configuration.',
    '',
    '## Upgrade Workflow',
    '',
  ...
  helmKubePrometheusStackChartDocs: [
    ...
    '## Best Practices',
    '',
    'Keep selector values explicit when chart upgrades affect rendered monitoring resources.',
    '',
    '## Upgrade Workflow',
    '',
